...
#ifndef PIECHARTS_SWIFT_H
#define PIECHARTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PieCharts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9PieCharts8PieChart")
...
@property (nonatomic) IBInspectable CGFloat outerRadius;
...
@property (nonatomic) IBInspectable CGFloat selectedOffset;
/// Duration it takes to slices to expand.
@property (nonatomic) IBInspectable double animDuration;
/// Start angle of chart, in degrees, clockwise. 0 is 3 o’clock, 90 is 6 o’clock, etc.
@property (nonatomic) IBInspectable CGFloat referenceAngle;
...
SWIFT_CLASS("_TtC9PieCharts13PieSliceLayer")
@interface PieSliceLayer : CALayer <CAAnimationDelegate>
