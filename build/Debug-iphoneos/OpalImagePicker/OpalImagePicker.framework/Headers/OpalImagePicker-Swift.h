...
#ifndef OPALIMAGEPICKER_SWIFT_H
#define OPALIMAGEPICKER_SWIFT_H
...
@property (nonatomic, copy) NSString * _Nullable navigationTitle;
/// Localized library segment title. Only displays when using external URLs in <code>UISegmentedControl</code>.
@property (nonatomic, copy) NSString * _Nullable librarySegmentTitle;
...
@property (nonatomic, copy) NSString * _Nullable maximumSelectionsAllowedMessage;
/// Localized “OK” string.
@property (nonatomic, copy) NSString * _Nullable okayString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
