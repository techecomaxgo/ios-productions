...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FSPopoverView/FSPopoverView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SSSwiftUILoader/SSSwiftUILoader.framework"
