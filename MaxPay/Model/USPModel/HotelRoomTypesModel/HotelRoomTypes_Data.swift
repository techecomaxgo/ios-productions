...
struct HotelRoomTypes_Data : Codable {
    
	let availableRoom : AvailableTypeRoom?
	...
	init(from decoder: Decoder) throws {
		...
		availableRoom = try values.decodeIfPresent(AvailableTypeRoom.self, forKey: .availableRoom)
