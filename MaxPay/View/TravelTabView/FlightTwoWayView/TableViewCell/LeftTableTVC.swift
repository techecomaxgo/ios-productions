...
class LeftTableTVC: UITableViewCell {
    ...
    func setLeftCellData(leftTableCellData: Segments?) {
        
        print(leftTableCellData!)
        
        bondsArr = []
        legsArr =  []
        
        fareDict = leftTableCellData?.fare
        
        bondsArr = leftTableCellData?.bonds
