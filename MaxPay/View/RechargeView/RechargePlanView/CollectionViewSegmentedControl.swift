...
@IBDesignable public final class CollectionViewSegmentedControl: UIControl {
    ...
    @IBInspectable public var selectedBackgroundColor: UIColor = UIColor(red: 0.81, green: 0.90, blue: 0.31, alpha: 1.00)
    

    @IBInspectable public var unselectedBackgroundColor: UIColor = UIColor.clear
    @IBInspectable public var selectedTextColor: UIColor = UIColor.label
    @IBInspectable public var unselectedTextColor: UIColor = UIColor.label
    @IBInspectable public var font: UIFont = UIFont.systemFont(ofSize: 12, weight: .medium)
