...
+ (void)activateAccountWithIin:(NSString * _Nonnull)iin account:(id _Nullable)account cardNo:(NSString * _Nonnull)cardNo exp:(NSString * _Nonnull)exp cardDetailsFlag:(BOOL)cardDetailsFlag viewController:(UIViewController * _Nonnull)viewController callback:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))callback;
...
+ (id _Nullable)getStoredValueWithKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
